...
public interface DeviceListInGroupActionType {
    ...
    String GET_GROUP_DEVICE_COUNT = "GET_GROUP_DEVICE_COUNT";
    String GET_GROUP_DEVICE_COUNT_SUCCESS = "GET_GROUP_DEVICE_COUNT_SUCCESS";
}
